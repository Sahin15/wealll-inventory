          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-2xl font-semibold text-gray-900">₹{data.totalStockValue.toFixed(2)}</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-2xl font-semibold text-gray-900">₹{data.todaySales.toFixed(2)}</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-2xl font-semibold text-gray-900">₹{data.monthlySales.toFixed(2)}</dd>
              </dl>
            </div>
          </div>
        </div>
