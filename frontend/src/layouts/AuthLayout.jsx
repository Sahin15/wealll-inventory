...
const AuthLayout = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-blue-100/90 via-purple-50/50 to-violet-100/90 flex flex-col justify-center py-6 sm:px-6 lg:px-8 font-sans selection:bg-blue-200 selection:text-blue-900 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md w-full px-4 sm:px-0">
          <div className="bg-white/90 backdrop-blur-xl py-6 sm:py-8 px-6 sm:px-10 shadow-[0_30px_60px_-15px_rgba(59,130,246,0.15)] ring-1 ring-violet-500/10 sm:rounded-3xl relative">
          <Outlet />
        </div>
          ...
          <div className="mt-6 text-center flex flex-col items-center justify-center gap-2">
            ...
            >
              <img src={wealllLogo} alt="WeAlll" className="h-3 sm:h-4 object-contain transition-all" />
            </a>
          </div>
        </div>
      </div>
